...
public class Exercises {
	...
	public String makeAbba(String a, String b) {
		String abba = a.concat(b) + b.concat(a);
	...
	public String makeOutWord(String out, String word) {
		String middle = out.substring(0, 2) + word + out.substring(2, 4);
		return middle;
	}
	...
	public String extraEnd(String str) {
		String copy = str.substring(str.length() - 2) + str.substring(str.length() - 2)
	...
	public String left2(String str) {
		String rotate = str.substring(2, str.length()) + str.substring(0, 2);
		return rotate;
	}
	...
	public boolean hasBad(String str) {
		if (str.length() < 3) {
			return false;
		} else if ((str.substring(0, 3)).contentEquals("bad")) {
			return true;
	...
	public String frontTimes(String str, int n) {
		...
		if (str.length() < 4) {
			...
			for (int i = 0; i < n; i++) {
				repeat3 = repeat3 + str.substring(0, 3);
			}
		}
		return repeat3;
	}
